var listing_config = {
	"releases.naturalcapitalproject.org": { // public domain of a bucket
		...
		// root_dir: "invest/",
		special_bucket_objects: "latest.json" // (optional) create special URLs that redirect to objects: {"#latest-invest-windows": "http://releases.naturalcapitalproject.org/invest/3.7.0/InVEST_3.7.0_x86_Setup.exe"}
	},
