...
gcloud storage cp index.html gs://releases.naturalcapitalproject.org
gcloud storage cp bucketlist.js gs://releases.naturalcapitalproject.org
gcloud storage cp config.js gs://releases.naturalcapitalproject.org
```

After deploying I sometimes needed to manually edit the "Type" of the javascript files.
